...
YOUR_EMAIL = "mattktam@gmail.com"
RECIPIENTS = ["mattktam@gmail.com", "ktam88@gmail.com"]
SPIKE_THRESHOLD = 20
...
def render_html_report(rows, base_date, compare_date, weekly_totals, monthly_totals):
    base_total    = sum(r["base_cost"]    for r in rows)
    compare_total = sum(r["compare_cost"] for r in rows)
    net           = compare_total - base_total
    net_pct       = (net / base_total * 100) if base_total else 0
...
def main(event=None, context=None):
    ...
    html = render_html_report(rows, base_date, compare_date, weekly_totals, monthly_totals)
